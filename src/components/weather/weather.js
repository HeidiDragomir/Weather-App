  ...
  return (
    ...
    <div className="container-main">
      ...
      <div className="weather">
        ...
        <div className="flex">
          <p className="temp">Temperature: <span>{data.current.temp.toFixed()}&deg;</span></p>
          <p className="temp">Feels like: <span>{data.current.feels_like.toFixed()}&deg;</span></p>
        </div>
      ...
      <div className="buttons">
        ...
        <span> / </span>
        <button className="info outline text-tiny" onClick={imperial}>&deg;F</button>
      </div>
